...
{
    public class IRC6697Detector : IServiceDetector
    {
        private readonly ILogger<IRC6697Detector> _logger;

        public string ServiceName => "IRC over SSL";
        public int[] CommonPorts => new[] { 6697 };
        public int Priority => 25;

        public IRC6697Detector(ILogger<IRC6697Detector> logger)
        {
            _logger = logger;
        }
